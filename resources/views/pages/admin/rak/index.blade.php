    ...
    <div class="col-12">
        <div class="card-box table-responsive">
            <a href="{{ route('rak-create') }}"
                class="btn btn-sm btn-success waves-effect w-md waves-light m-b-30">Tambah Rak</a>
            ...
            <table id="datatable" class="table table-bordered">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="btn-group">
                                <a href="{{ route('rak-show', $rak->id) }}" type="button"
                                    class="btn btn-primary waves-effect btn-sm"><i class="fa fa-eye"></i></a>
                                <a href="{{ route('rak-edit', $rak->id) }}" type="button"
                                ...
                                <button type="submit" class="btn btn-danger waves-effect btn-sm" data-toggle="modal"
                                    data-target="#deleteModal" data-id="{{ $rak->id }}"><i
...
<script type="text/javascript">
    ...
    $('#deleteModal').on('show.bs.modal', function (event) {
        ...
        form.attr('action','/rak/delete/' + varId); // action dari form dan menghapus berdasarkan id
    });
</script>
@endpush