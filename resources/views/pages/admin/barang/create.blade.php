            ...
            <form role="form" method="POST" action="{{ route('barang-store') }}">
                ...
                <div class="form-group">
                    ...
                    <select name="kd_satuan" id="deskripsiInput" class="form-control">
                        ...
                        <option value="{{ $satuan->id }}" {{ old('kd_satuan')==$satuan->id ? 'selected' : null
                            }}>{{
                ...
                <div class="form-group">
                    ...
                    <select name="kd_klasifikasi" id="deskripsiInput" class="form-control">
                        ...
                        <option value="{{ $klasifikasi->id }}" {{ old('kd_klasifikasi')==$klasifikasi->id ? 'selected' :
                            null
                            }}>{{
                ...
                <div class="form-group">
                    ...
                    <select name="kd_rak" id="deskripsiInput" class="form-control">
                        ...
                        @foreach ($rak as $rak )
                        <option value="{{ $rak->id }}" {{ old('kd_rak')==$rak->id ? 'selected' : null
                            }}>{{
                            $rak->rak}}</option>
                        @endforeach
                    </select>
                ...
                <div class="form-group">
                    ...
                    <select name="kd_gudang" id="deskripsiInput" class="form-control">
                        ...
                        <option value="{{ $gudang->id }}" {{ old('kd_gudang')==$gudang->id ? 'selected' : null
                            }}>{{
