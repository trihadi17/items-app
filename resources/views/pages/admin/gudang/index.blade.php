    ...
    <div class="col-12">
        <div class="card-box table-responsive">
            <a href="{{ route('gudang-create') }}"
                class="btn btn-sm btn-success waves-effect w-md waves-light m-b-30">Tambah Gudang</a>
            ...
            <table id="datatable" class="table table-bordered">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="btn-group">
                                <a href="{{ route('gudang-show', $gudang->id) }}" type="button"
                                    class="btn btn-primary waves-effect btn-sm"><i class="fa fa-eye"></i></a>
                                <a href="{{ route('gudang-edit', $gudang->id) }}" type="button"
                                ...
                                <button type="submit" class="btn btn-danger waves-effect btn-sm" data-toggle="modal"
                                    data-target="#deleteModal" data-id="{{ $gudang->id }}"><i
...
<script type="text/javascript">
    ...
    $('#deleteModal').on('show.bs.modal', function (event) {
        ...
        form.attr('action','/gudang/delete/' + varId); // action dari form dan menghapus berdasarkan id
    });
</script>
@endpush