   ...
   public function index(){
    ...
    public function store(KlasifikasiRequest $request){
        try {
            ...
            return redirect('/klasifikasi/create')->with('success', 'Data berhasil ditambahkan');
        } catch (\Throwable $e) {
            // batalkan semua proses
            DB::rollBack();

            return redirect('/klasifikasi/create')->with('error', 'Terjadi kesalahan, silahkan coba lagi');
        }
    }
